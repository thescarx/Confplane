...
function PendingArticlesTable() {
  ...
  useEffect(() => {
    let url = "http://192.168.8.101:8000/articles/listforchairman/path/?conference_id="+id+"&status=pending";
    console.log(url)
    axios
      .get(url)
  ...
  //   const res = await axios.get("http://192.168.8.101:8000/users/" + id);
